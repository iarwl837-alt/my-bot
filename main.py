...
API_TOKEN = '5169566805:AAEVDUxmyVH7qnc6ZRR2pJ6XarIAhMWkFrU'  
...
async def run_mass_checker_with_sites_file(message: types.Message, state: FSMContext):
    ...
    try:
        ...
        if not cards or not sites:
            await message.answer("❌ ملف البطاقات أو ملف المواقع فارغ أو تنسيقه غير صحيح.")
            await state.finish()
            return
