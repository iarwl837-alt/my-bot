...
stopuser = {}
token = '8649508720:AAG-xCrSbTL35WSnhewhCloK_8c-NTFP1Kw'
...
User Bot : @TomeCheckerBot {BL}</b>
	''',reply_markup=keyboard)
		...
		video_url = f'https://t.me/zdtuuu/35'
		bot.send_video(chat_id=message.chat.id, video=video_url, caption='''𝘾𝙡𝙞𝙘𝙠 /cmds 𝙏𝙤 𝙑𝙞𝙚𝙬 𝙏𝙝𝙚 𝘾𝙤𝙢𝙢𝙖𝙣𝙙𝙨 𝙊𝙧 𝙎𝙚𝙣𝙙 𝙏𝙝𝙚 🇫🇮𝙡𝙚 𝘼𝙣𝙙 𝙄 𝙒𝙞𝙡𝙡 𝘾𝙝𝙚𝙘𝙠 𝙄𝙩''',reply_markup=keyboard)
